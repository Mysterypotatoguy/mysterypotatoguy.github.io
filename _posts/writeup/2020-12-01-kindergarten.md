...
Next, deciding where to redirect program flow to. We have the user-controlled buffer `ans` from earlier which is perfect for our needs [^1]
...
- Not using some tools like pwnlib
- Assembly is 32 bit
- Some inefficiencies in the assembly
